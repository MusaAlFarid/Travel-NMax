                    ...
                    <div class="card card-details">
                            ...
                            <table class="table table-responsive-sm text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="#">
                                            <img src="{{url ('frontend/images/icon_delete.png') }}" alt="">
                                            </a>
                                        </td>
                                    </tr>
                        ...
                        <div class="member mt-3">
                            ...
                            <p class="disclaimer mb-0">
                                You are only able to invite member that has registed in NMax.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card card-details card-right">
                        ...
                        <div class="bank">
                            ...
                            <img src="{{url ('frontend/images/pay.png')}}" alt="" class="bank-image">
